...
export const CODE_ZH = {
    ...
    getCodesZH: function (code) {
        return this.codes[code] || '未知类型'
    },
    getCommandsZH: function (command) {
        return this.commands[command] || '未知类型'
    }
